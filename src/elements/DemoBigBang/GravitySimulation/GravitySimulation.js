...
export default class GravitySimulation extends HTMLElement {
  constructor() {
    super();
    initInstance(this, GravitySimulation.TEMPLATE);
    this._canvasElement = this.shadowRoot.querySelector("canvas");
    this._canvasElementCtx = this._canvasElement.getContext("2d");
  ...
  set height(num) {
    ...
    if (num !== this._height) {
      this._height = num;
      this._centerY = num / 2;
      this._canvasElement.height = num;
      this._bufferCanvas.height = num;
      this._canvasElementCtx.globalCompositeOperation = "copy";
    }
  }
  ...
  draw() {
    ...
    this._canvasElementCtx.drawImage(
      this._bufferCanvas,
      0,
      0,
      this._width,
...
GravitySimulation.TAG_NAME = "gravity-simulation";
GravitySimulation.HTML = require("!raw-loader!./GravitySimulation.html").default;
GravitySimulation.CSS = require("!raw-loader!./GravitySimulation.css").default;
GravitySimulation.observedAttributes = [
  "active",
  "antimatter",
  "height",
  "max-mass",
