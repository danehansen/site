...
export default class ScrollCapture extends HTMLElement {
  constructor() {
    super();
    initInstance(this, ScrollCapture.TEMPLATE);
  ...
  _onScroll(evt) {
    // console.log("ScrollCapture._onScroll", evt);
...
ScrollCapture.TAG_NAME = "scroll-capture";
ScrollCapture.HTML = require("!raw-loader!./ScrollCapture.html").default;
ScrollCapture.CSS = require("!raw-loader!./ScrollCapture.css").default;
