...
(function () {
	...
	function onModalClick(evt) {
		...
		if (MyUtils.hasClass(content, "photo")) {
			...
			videoIsPlaying = true;
			if (!youtube)
				youtube = new YT.Player('player', { height: '540', width: '960', videoId: evt.currentTarget.getAttribute("data-youtube-id"), events: { 'onReady': onPlayerReady, 'onStateChange': onPlayerStateChange } });
			else
